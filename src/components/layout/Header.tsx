        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              ...
              <Link
                href="/auth/login"
                className="bg-brand-gold hover:bg-brand-gold-dark text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-brand-gold"
              >
                Sign In
              </Link>
            )}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-brand-gold-50 border-t border-brand-gold-200">
              ...
              <div className="flex items-center justify-end px-3 py-2">
                {user ? (
                  ...
                  <Link
                    href="/auth/login"
                    className="bg-brand-gold hover:bg-brand-gold-dark text-white px-4 py-2 rounded-md text-sm font-medium shadow-brand-gold transition-colors"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Sign In
                  </Link>
